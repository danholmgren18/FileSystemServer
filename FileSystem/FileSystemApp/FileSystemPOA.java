...
* from FileSystem.idl
* Wednesday, December 2, 2020 at 12:52:14 PM Eastern Standard Time
*/
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 4:  // FileSystemApp/FileSystem/openFileForWrite
       {
         ...
         String $result = null;
         $result = this.openFileForWrite (title, linenum);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }

       case 5:  // FileSystemApp/FileSystem/updateFileAfterWrite
       {
         String newLine = in.read_string ();
         String title = in.read_string ();
         short lineNum = in.read_short ();
         String $result = null;
         $result = this.updateFileAfterWrite (newLine, title, lineNum);
         out = $rh.createReply();
         out.write_string ($result);
         break;
       }
