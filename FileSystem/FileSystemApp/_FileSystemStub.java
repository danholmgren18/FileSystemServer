...
public class _FileSystemStub extends org.omg.CORBA.portable.ObjectImpl implements FileSystemApp.FileSystem
{
  ...
  public String openFileForWrite (String title, short linenum)
  {
            ...
            try {
                ...
                return openFileForWrite (title, linenum        );
            } finally {
                _releaseReply ($in);
            }
  } // openFileForWrite
  ...
  public String updateFileAfterWrite (String newLine, String title, short lineNum)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("updateFileAfterWrite", true);
                ...
                return updateFileAfterWrite (newLine, title, lineNum        );
            } finally {
                _releaseReply ($in);
            }
  } // updateFileAfterWrite
